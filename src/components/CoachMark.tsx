 ...
 *
 * 덮개는 `pointer-events: none`이라 클릭이 그대로 통과하고, 진행은 BriefingPage가 창
 * 전체에서 가로챕니다(하단 고정 CTA·배너 위에도 떠야 해서 zIndex는 그보다 높은 1000).
...
export function CoachMark({
  ...
  useEffect(() => {
    ...
    // 네트워크를 기다렸다 뒤늦게 그려지는 것도 있어서 시간을 정해두고 멈추면
    // 영영 못 찾습니다. 투어 중에만 붙어 있어 비용은 작아요.
    let raf = 0;
    const tick = () => {
      update();
